...
class ControlFlowGraphReferenceTransformer : FirTransformer<ControlFlowGraph>() {
    override fun <E : FirElement> transformElement(element: E, data: ControlFlowGraph): CompositeTransformResult<E> {
        return element.compose()
    }

    override fun transformFunction(function: FirFunction, data: ControlFlowGraph): CompositeTransformResult<FirDeclaration> {
